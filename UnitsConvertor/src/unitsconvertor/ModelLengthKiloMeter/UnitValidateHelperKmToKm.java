...
public class UnitValidateHelperKmToKm {
    public static boolean checkKiloMeterToKiloMeter(String inputOne,String inputTwo){
    ...
    public static boolean checkKiloMeterToKiloMeter(String inputOne,String inputTwo,String output){
