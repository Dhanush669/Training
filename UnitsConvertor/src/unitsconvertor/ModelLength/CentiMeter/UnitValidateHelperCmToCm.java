...
public class UnitValidateHelperCmToCm {
    public static boolean checkCentiMeterToCentiMeter(String inputOne,String inputTwo){
    ...
    public static boolean checkCentiMeterToCentiMeter(String inputOne,String inputTwo,String output){
